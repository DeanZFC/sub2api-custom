export default {
  ...
  keys: {
    ...
    clickToChangeFallbackGroup: 'Click to change fallback group',
    groupChangedSuccess: 'Group changed successfully',
    groupChangedFallbackClearedSuccess: 'Primary group changed; the incompatible fallback group was cleared',
    fallbackGroupChangedSuccess: 'Fallback group changed successfully',
    failedToChangeGroup: 'Failed to change group',
    failedToChangeFallbackGroup: 'Failed to change fallback group',
