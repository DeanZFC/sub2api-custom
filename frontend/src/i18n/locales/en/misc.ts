export default {
  ...
  version: {
    ...
    sourceUpdaterReady: 'Source updater ready',
    sourceUpdateStage: 'Update stage',
    sourceUpdateInvalidResponse: 'The source updater returned an invalid response',
    sourceUpdateTimeout: 'The source update timed out',
