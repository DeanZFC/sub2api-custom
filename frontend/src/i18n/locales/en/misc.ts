export default {
  ...
  version: {
    ...
    sourceModeHint: 'Host updater is not installed; use git pull manually',
    sourceUpdaterReady: 'Host updater is ready; updates can run here',
    sourceUpdateStage: 'Update progress',
    sourceUpdateInvalidResponse: 'The host updater returned an invalid job',
    sourceUpdateTimeout: 'Update timed out; check the host updater logs',
    sourceStages: {
      queued: 'Queued',
      ...
      deploying: 'Recreating application',
