export default {
    ...
    channels: {
      ...
      form: {
        ...
        ruleModelPricing: 'Model Pricing',
         ...
         unnamed: 'Unnamed',
         splitDefaultPrices: 'Split by default prices',
         splitDefaultPricesSuccess: 'Split by model default prices. Review the prices and save the channel.',
         splitDefaultPricesUnchanged: 'No models with different default prices found. Existing prices kept.',
         pricingChangedDuringSync: 'Pricing changed while syncing. Please try again.',
    ...
    riskControl: {
      ...
      userWhitelistHint: 'Selected users skip content moderation, including audit records, notifications, and automatic bans. Applies to all groups and models; an empty list exempts no users.',
      userWhitelistEmpty: 'No whitelisted users',
