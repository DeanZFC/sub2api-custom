export default {
    tests: {
      groupWorkflow: {
        ...
        description: 'Test all accounts in both groups. A candy result equal to 21 selects the pass group; a different result or a final execution failure selects the fail group. An administrator can immediately override this round by marking the pelican result pass or fail.',
        publicVote: 'Allow users to vote on the pelican result',
        publicVoteHint: 'User votes change the group when a threshold is met, with the fail threshold taking priority. Administrator decisions override user votes. Votes reset each round, and candy is still judged automatically against 21.',
        privateReviewHint: 'Off by default. Only administrators can decide the pelican result. Closing user voting keeps administrator decisions available.',
