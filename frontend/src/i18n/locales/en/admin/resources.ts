export default {
    tests: {
      protection: {
        ...
        title: 'Automatic quality protection',
        description: 'Pause account scheduling after a failed quality check. Resume after subsequent checks clear every issue. Accounts with scheduling manually disabled are neither tested nor automatically resumed.',
        accountOnly: 'Select one account or all accounts to enable protection. Group checks do not change account scheduling.',
        pauseOnFailure: 'Pause the account when a check fails',
        ...
        rejectAbove: 'Pause when failed votes exceed',
        passAtLeast: 'Allow recovery when passed votes reach',
        voteHint: 'One vote per user per round; votes can be changed. Each new check starts a new round. Excess failed votes and other unresolved issues always block recovery.',
        referenceAnswer: 'Reference answer (optional, displayed to voters only)',
        expectedAnswer: 'Expected answer (optional, pause on mismatch)',
        answerMatch: 'Answer comparison', exact: 'Exact match', contains: 'Contains expected text', numeric: 'Numeric equality',
        rulesHint: 'Any failure threshold pauses the account. Missing data or too few samples neither pass nor fail a check. Configure at least one rule. Percentages use 0–100; latency uses milliseconds.',
        invalid: 'Enable at least one valid rule and check its thresholds, samples, answer and voting limits.',
