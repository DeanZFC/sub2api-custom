export default {
    tests: {
      ...
      title: 'Test Management', description: 'Configure test types, groups, models, and schedules', types: 'Test Types', plans: 'Test Plans', name: 'Name', key: 'Key', type: 'Type', target: 'Target', group: 'Group', account: 'Account', accountOptional: 'Account target', accountHint: 'Only the selected account is tested; its ID is shown in user results.', groupHint: 'Run the group test; user results do not expose an account ID.', allAccountsHint: 'Test every schedulable account in this group; each result includes its account ID.', groupTest: 'No account (group test)', allAccountsInGroup: 'All accounts in this group', enablePlan: 'Enable', disablePlan: 'Disable', retry: 'Retry', retryStarted: 'Account test retry started.', selectGroupFirst: 'Select a group first', selectType: 'Select a test type', selectGroup: 'Select a group', selectAccount: 'Select an account', model: 'Model', reasoningEffort: 'Reasoning effort', reasoningEffortDefault: 'Model default', reasoningEffortHint: 'Only levels supported by the selected model and target accounts are shown.', schedule: 'Schedule', cron: 'Cron expression', manual: 'Manual', run: 'Run now', results: 'Results', kind: 'Output type', number: 'Number', text: 'Text', descriptionLabel: 'Description', prompt: 'Prompt', maxResults: 'Max results', htmlResult: 'HTML test result', sortOrder: 'Display order', sortOrderHint: 'Lower values appear first in user test result tabs.', planSortOrderHint: 'Lower values place this test rule’s group earlier in user results.', uncategorized: 'Uncategorized'
    },
    scheduledTests: {
