export default {
    accounts: {
      ...
      openai: {
        prism: {
          title: 'Prism experimental channel',
          description: 'Off by default. Supports text-only Responses and Chat Completions. Turning it off restores the original channel.',
          contextHint: 'Each request creates a separate Prism project. Clients must send the complete conversation context. The request model and existing account model mappings are used.',
          unsupportedHint: 'Client tools, previous_response_id, and images are not supported.',
          usageHint: 'No token fees are charged when the upstream does not return usage.',
          authMode: 'Authentication',
          authModeAccount: 'Use account authentication (recommended)',
          authModeCookie: 'Manual Cookie',
          authModeAccountHint: 'Uses this account’s saved OpenAI credentials to establish a Prism session automatically. Acceptance depends on Prism; if rejected, switch to Manual Cookie and enter the session Cookie from a Prism login.',
          cookie: 'Prism Cookie',
          cookiePlaceholder: 'Enter the Cookie from your Prism session',
          cookieKeepPlaceholder: 'Leave blank to keep the saved Cookie',
          cookieHint: 'Required when first enabling Manual Cookie mode. The saved Cookie will not be displayed.',
          cookieConfiguredHint: 'A Cookie is saved. Leave blank to keep it, or enter a new value to replace it.',
          cookieRequired: 'Enter a Prism Cookie before using Manual Cookie mode.',
          timeout: 'Total timeout (seconds)',
          timeoutHint: '30–600 seconds, including project creation and response generation. Default: 180 seconds.',
          timeoutInvalid: 'Prism timeout must be a whole number from 30 to 600 seconds.',
          advanced: 'Advanced settings',
          actionId: 'Conversation action ID',
          actionIdPlaceholder: 'Leave blank to use the built-in version',
          actionIdHint: 'Override only when the Prism conversation action changes. Enter a 42-character hexadecimal ID from your capture.',
          actionIdInvalid: 'The Prism conversation action ID must contain exactly 42 hexadecimal characters.'
        },
        ...
        codexFingerprintModeDesc: 'Keep Codex identity signals stable and isolated per account. This changes identity/cache/session markers, not the proxy IP or network egress.',
        ...
        antiDegrade: 'Account protection',
        antiDegradeDesc: 'Applies immediately to existing accounts. Generic protection bounds concurrency; identity strategies also pin identity and transport. This cannot guarantee upstream model quality.',
        antiDegradeEnabled: 'Enabled',
        antiDegradeActiveMode: 'Active strategy',
        antiDegradeMode: 'Protection strategy',
        antiDegradeModeHint: 'Choose before enabling. While enabled, select another strategy, review its configuration, then apply it immediately.',
        antiDegradeApplying: 'Applying account protection…',
        antiDegradeActiveHint: 'The active strategy is persisted. Disabling restores the settings it manages. Generic protection leaves identity, proxy, and transport unchanged.',
        antiDegradeApplyStrategy: 'Apply selected strategy',
        antiDegradeConfiguredTransport: 'Configured transport',
        antiDegradeConfiguredIdentity: 'Configured identity',
        antiDegradeRuntimeHint: 'This is the configured target. The global TLS switch, proxy, plugin transport, and connection reuse can affect the actual outbound connection.',
        antiDegradeDisable: 'Disable and restore',
        antiDegradeDisableTitle: 'Disable account protection?',
        antiDegradeDisableMessage: 'This immediately restores the settings managed by the active strategy. Generic concurrency protection does not change identity, proxy, or transport.',
        antiDegradeDisableConfirm: 'Disable protection',
        antiDegradeApplied: 'Account protection strategy applied',
        antiDegradeReverted: 'Account protection disabled and previous settings restored',
        antiDegradeFailed: 'Failed to update account protection',
        protectionPolicy: 'Account protection policy',
        protectionPolicyDesc: 'Uses the existing Codex identity/TLS settings and adapts runtime concurrency from final upstream outcomes.',
        protectionEnabled: 'Enable protection policy',
        protectionAdaptive: 'Adaptive concurrency',
        protectionAdaptiveDesc: 'Automatically lowers runtime concurrency after repeated upstream 429/5xx; saved account concurrency remains the ceiling.',
        protectionAutomatic: 'Automatic adjustment',
        protectionObserve: 'Observe only',
        protectionMinConcurrency: 'Minimum runtime concurrency',
