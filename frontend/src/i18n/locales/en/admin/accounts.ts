    ...
    accounts: {
      ...
      openai: {
        prism: {
          ...
          cookieHint: 'Required when enabling for the first time. The saved Cookie will not be displayed.',
          cookieConfiguredHint: 'A Cookie is saved. Leave blank to keep it, or enter a new value to replace it.',
          cookieRequired: 'Enter a Prism Cookie before enabling this channel.',
