export default {
    accounts: {
      ...
      editConcurrency: 'Edit Concurrency',
      concurrencyEditHint: 'Set how many requests this account can handle at once.',
      decreaseConcurrency: 'Decrease concurrency',
      increaseConcurrency: 'Increase concurrency',
      ...
      expired: 'Expired',
      proxy: 'Proxy',
      proxyConcurrencyLimitEnabled: 'Enable per-proxy 429 concurrency limiting',
      proxyConcurrencyLimitEnabledHint: 'Each selected proxy gets its own concurrency limit when enabled.',
