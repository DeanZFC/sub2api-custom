export default {
    accounts: {
      ...
      openai: {
        ...
        codexTicketAccountEnabledDesc: 'Ticket harvesting uses this account’s own proxy route, or a direct connection when no proxy is configured. Ticket length follows the account subscription: 292 for Pro, 332 for Team. Applies only to this OpenAI OAuth / Setup Token account.',
        codexTicketFailClosed: 'Pause models without a ticket',
        codexTicketFailClosedDesc: 'Enabled by default. Pause the corresponding model without a valid ticket; turn off to keep requests flowing while harvesting continues.',
