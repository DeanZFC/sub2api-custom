export default {
    accounts: {
      ...
      openai: {
        ...
        codexTicketAccountEnabledDesc: 'Harvesting uses this account’s own proxy route, or a direct connection when no proxy is configured. Pro uses 292; Team uses 332. Tickets last at most 240 seconds by default and renew 60 seconds early. Required 292 routing cookies are collected automatically and shared across models within this account only.',
