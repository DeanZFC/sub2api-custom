export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'New accounts default to single-machine mode; existing accounts without a configured mode stay off. Official device, session and full modes remain available. Single-machine mode adds stable windows and a Mac TLS profile, preserves conversation caches, and does not change concurrency or isolate accounts.',
        ...
        codexTurnTicketDesc: 'Availability for the configured models. For 292 tickets, the countdown includes both ticket and routing cookie expiry. With fail-closed enabled, a missing ticket or missing valid 292 cookies pauses the model.',
        codexTicketAccountEnabled: 'Codex 292 / 332 tickets',
        codexTicketAccountEnabledDesc: 'Harvesting uses the account’s primary proxy, or a direct connection when no proxy is configured; the business proxy pool may use other exits. Pro uses 292; Team uses 332. Tickets last at most 240 seconds by default and renew 60 seconds early. Required 292 routing cookies are collected automatically and shared across models within this account only.',
        codexTicketFailClosed: 'Pause models without a ticket',
        codexTicketFailClosedDesc: 'Enabled by default. Pause the model without a valid ticket or valid routing cookies for 292; turn off to keep requests flowing while harvesting continues.',
        ...
        codexTicketDiagnostics: {
          ...
          proxyDirect: 'Direct',
          proxyPool: 'Pool #{index}',
          lastAttempt: 'Last attempt: {time}',
          nextRetry: 'Next retry: {time}',
          nextCheck: 'Next recovery check: {time}',
          nextRefresh: 'Next renewal: {time}',
          cookieReady: 'Account routing cookies: {seconds} seconds left',
          cookieMissing: 'Account routing cookies: missing or expired',
          ...
          errors: {
            ...
            cookie_missing: 'Routing cookies are missing or expired',
            no_proxy: 'The account proxy is missing or invalid; check its proxy settings',
            proxy_cooldown: 'The account route is cooling down or at capacity; waiting to retry',
        ...
        codexTicketHistory: {
          ...
          hint: 'The latest {limit} harvests from this service run; cleared on restart.',
          empty: 'No harvest history yet',
          loadFailed: 'Could not load harvest history. Refresh to retry.',
          success: 'Success',
          failure: 'Failed',
          canceled: 'Canceled',
