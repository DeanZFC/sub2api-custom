export default {
    accounts: {
      ...
      openai: {
        ...
        codexTicketAccountEnabledDesc: 'Uses the gateway harvest proxy pool. Ticket length follows the account subscription: 292 for Pro, 332 for Team. Applies only to this OpenAI OAuth / Setup Token account.',
