      ...
      gatewayForwarding: {
        ...
        codexTicketProxyTest: {
          ...
          errors: {
            ...
            invalid_proxy: 'Invalid proxy configuration; check and save it again',
            busy: 'An exit test is already running; try again later',
            timeout: 'Exit test timed out',
            canceled: 'Exit test canceled',
            proxy_auth: 'Proxy authentication failed; check its username and password',
            proxy_error: 'Could not connect to the proxy; check its configuration',
            redirect_blocked: 'Exit check returned an unsupported redirect',
            upstream_error: 'Exit check service is temporarily unavailable',
            invalid_response: 'No valid exit IP was returned',
            unknown: 'Could not complete the exit test; try again later',
          },
        },
