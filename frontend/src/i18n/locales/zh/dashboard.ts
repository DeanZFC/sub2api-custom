export default {
  ...
  keys: {
    ...
    clickToChangeFallbackGroup: '点击更换兜底分组',
    groupChangedSuccess: '分组更换成功',
    groupChangedFallbackClearedSuccess: '主分组更换成功，原兜底分组因不兼容已清空',
    fallbackGroupChangedSuccess: '兜底分组更换成功',
    failedToChangeGroup: '更换分组失败',
    failedToChangeFallbackGroup: '更换兜底分组失败',
    groupRequired: '请选择分组',
    usage: '用量',
    today: '今日',
    total: '近30天',
