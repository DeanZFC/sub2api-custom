export default {
  ...
  version: {
    ...
    refresh: '刷新',
    sourceMode: '源码构建',
    sourceModeHint: '未安装宿主机更新器，请手动 git pull 更新',
    sourceUpdaterReady: '宿主机更新器已就绪，可在此处自动更新',
    sourceUpdateStage: '更新进度',
    sourceUpdateInvalidResponse: '宿主机更新器返回了无效任务',
    sourceUpdateTimeout: '更新超时，请检查宿主机更新器日志',
    sourceStages: {
      queued: '等待执行',
      validating: '检查部署',
      backing_up: '备份数据库',
