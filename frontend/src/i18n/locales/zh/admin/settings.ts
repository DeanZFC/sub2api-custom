      ...
      gatewayForwarding: {
        ...
        codexTicketProxyTest: {
          ...
          errors: {
            ...
            invalid_proxy: '代理配置无效，请检查后重新保存',
            busy: '已有出口测试正在运行，请稍后重试',
            timeout: '出口测试超时',
            canceled: '出口测试已取消',
            proxy_auth: '代理认证失败，请检查用户名和密码',
            proxy_error: '代理连接失败，请检查配置',
            redirect_blocked: '出口检测返回了不支持的重定向',
            upstream_error: '出口检测服务暂时不可用',
            invalid_response: '未获取到有效出口 IP',
            unknown: '暂时无法完成出口测试，请稍后重试',
          },
        },
