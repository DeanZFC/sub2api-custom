export default {
    accounts: {
      ...
      crsBack: '返回',
      editAccount: '编辑账号',
      editConcurrency: '编辑并发',
      concurrencyEditHint: '调整该账号可同时处理的请求数。',
      decreaseConcurrency: '减少并发数',
      ...
      expired: '已过期',
      proxy: '代理',
      proxyConcurrencyLimitEnabled: '开启卡 429 并发限流',
      proxyConcurrencyLimitEnabledHint: '开启后每个代理独立限制并发，关闭时沿用单代理并发限制。',
      proxyPool: '代理出口（可多选）',
