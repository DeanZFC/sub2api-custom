...
// ProvideUserHandler keeps the user-facing scheduled test results wired when
// regenerating the application's dependency graph.
func ProvideUserHandler(
	...
	h.SetScheduledTestService(scheduledTestService)
	return h
}
