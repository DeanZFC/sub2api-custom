...
func TestScheduledTestPlanRepositoryCreatePersistsName(t *testing.T) {
	...
	mock.ExpectQuery(`(?s)INSERT INTO scheduled_test_plans \(name, account_id`).
		...
		WillReturnRows(sqlmock.NewRows([]string{
			"id", "name", "account_id", "group_id", "test_definition_id", "test_type", "model_id", "cron_expression", "enabled", "max_results", "auto_recover", "last_run_at", "next_run_at", "created_at", "updated_at",
