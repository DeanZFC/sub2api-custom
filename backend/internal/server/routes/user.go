...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.GET("/shared-pool/accounts/:id", h.SharedAccountPool.GetAccount)
			...
			user.GET("/shared-pool/accounts/:id/models", h.SharedAccountPool.GetAvailableModels)
			user.POST("/shared-pool/accounts/:id/test", panelRateLimiter.Heavy(), h.SharedAccountPool.TestAccount)
			...
			user.PUT("/shared-pool/listings/:id/listed", h.SharedAccountPool.SetListed)
